...
+ Le lab suivant [LabSkillBuilder-Refactor](3-LabSkillBuilder-Refactor.md) — durée estimée : 1–2h — vous permet d'expérimenter la création d'une skill pour optimiser la génération de programmes COBOL.

+ Enfin le lab [LabOptimizeSQL&DB2Config](4-LabOptimizeSQL&DB2Config.md) — durée estimée : 1–2h — vous permet de travailler sur l'optimisation des requêtes SQL et des accès DB2 dans l'application CBSA.
